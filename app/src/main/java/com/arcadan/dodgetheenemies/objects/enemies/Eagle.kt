...
class Eagle(override var sprite: Bitmap) : IPhysicalObject {
    ...
    override fun update() {
        coordinates.y += GameParameters.instance.deltaSpeed
    ...
    init {
        ...
        coordinates.x = Random.nextInt(Global.instance.measures.width - size.width)
        coordinates.y = 0
